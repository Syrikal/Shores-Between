...
public class MosasaurusRenderer extends MobRenderer<Mosasaurus, MosasaurusModel<Mosasaurus>> {
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(Mosasaurus entity) {
    ...
    @Override
    public void render(Mosasaurus p_entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
