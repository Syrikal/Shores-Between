package com.syric.shores_between.worldgen.tree;
...
public class SBTreeGrowers {
    public static final TreeGrower MISTWOOD_TREE = tree("mistwood_tree", SBConfiguredFeatures.MISTWOOD_TREE);
...
//
    public static final TreeGrower MISTWOOD_BUSH = tree("mistwood_bush", SBConfiguredFeatures.MISTWOOD_BUSH);
